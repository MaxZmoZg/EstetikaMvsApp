...
namespace Estetika.Controllers
{
    public class TovarsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Tovar,Imya_Tovar,Photo_Tovar,ID_Tip_Tovar,Prais,Opisanie_Tovar,ID_Polzovatel")] Tovar tovar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Tovar,Imya_Tovar,Photo_Tovar,ID_Tip_Tovar,Prais,Opisanie_Tovar,ID_Polzovatel")] Tovar tovar)
        {
            if (ModelState.IsValid)
            {
